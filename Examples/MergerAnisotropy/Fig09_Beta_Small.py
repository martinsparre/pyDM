...
plt.subplots_adjust(left=0.08, bottom=0.15, right=0.97, top=0.91,wspace=0.21, hspace=0.2)


plt.subplot(1,3,1)
plt.title('All particles',fontsize=24)
plt.plot(log10(GridSphA.R),GridSphA.Beta,'-*',label=r'Spherical',color='black',lw=2,ms=9)
...
SetLabels(20,20)
#plt.annotate(r'$r_{-2}$', xy=(-0.296, 0.35), xytext=(-0.296, 0.5),fontsize=26,ha='center',arrowprops=dict(facecolor='grey', shrink=0.05))
plt.annotate(r'$r_{-2}$', xy=(-0.09, 0.5), xytext=(-0.09, 0.65),fontsize=26,ha='center',arrowprops=dict(facecolor='grey', shrink=0.05))
plt.ylim((-0.3,0.9))
plt.xlim((-1,1))
...
plt.subplot(1,3,2)
plt.title('Accreted particles',fontsize=24)
plt.plot(log10(GridSphA.R),GridSphA.Beta,'-*',label=r'Spherical',color='black',lw=2,ms=9)
plt.plot(log10(GridSphB.R),GridSphB.Beta,'-o',label=r'$x$-axis',color='blue',lw=2,ms=9)
plt.plot(log10(GridSphC.R),GridSphC.Beta,'-D',label=r'$y$-axis',color='red',lw=2,ms=9)
if ImpactParameter:
...
plt.subplot(1,3,3)
plt.title('Merger remnant',fontsize=24)
plt.plot(log10(GridSphA.R),GridSphA.Beta,'-*',label=r'Spherical',color='black',lw=2,ms=9)
plt.plot(log10(GridSphB.R),GridSphB.Beta,'-o',label=r'$x$-axis',color='blue',lw=2,ms=9)
plt.plot(log10(GridSphC.R),GridSphC.Beta,'-D',label=r'$y$-axis',color='red',lw=2,ms=9)
if ImpactParameter:
