...
plt.subplots_adjust(left=0.09, bottom=0.13, right=0.95, top=0.95,wspace=0.25, hspace=0.2)
plt.subplot(1,2,2)
...
plt.text(0.5,-0.26,r'$\sigma^2$',color='black',fontsize=24)
plt.text(0.5,-0.40,r'$\sigma_\textrm{tan}^2$',color='blue',fontsize=24)
...
IC = DM_structure.DM_structure('../1HQOM_000')
ICGridSph = IC.CreateGridLogBins(NBins=75,Rmin=0.001,Rmax=9.9)
...
SetLabels(20,20)
plt.annotate(r'$r_{-2}$', xy=(-0.327, 0.45), xytext=(-0.327, 0.6),fontsize=26,ha='center',arrowprops=dict(facecolor='grey', shrink=0.05))
plt.show()
